...
void main() {
  ...
  group("Testing the 'EquationScaffold' widget", () {
    testWidgets('Making sure that the scaffold can be rendered',
        (tester) async {
    ...
    testWidgets('Making sure that the navigation scaffold can be rendered',
        (tester) async {
    ...
    testWidgets(
        ...
        'navigation items, throws an assertion error', (tester) async {
      expect(
