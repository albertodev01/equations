...
abstract class Algebraic {
  late final List<Complex> _coefficients;
  ...
  bool get isRealEquation => _coefficients.any((value) => value.imaginary == 0);
  ...
  List<Complex> get coefficients => UnmodifiableListView(_coefficients);
