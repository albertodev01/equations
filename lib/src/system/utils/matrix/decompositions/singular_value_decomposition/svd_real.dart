...
final class SVDReal extends SingleValueDecomposition<double, RealMatrix>
  ...
  List<RealMatrix> decompose() {
    ...
    final matrixU = List<List<double>>.generate(
      matrix.rowCount,
      (_) => List<double>.generate(maxRowCol, (_) => 0),
    );
    ...
    final arrayE = List<double>.generate(matrix.columnCount, (_) => 0);
    final helperArray = List<double>.generate(matrix.rowCount, (_) => 0);
