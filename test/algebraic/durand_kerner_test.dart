...
import 'package:equations/src/algebraic/types/durand_kerner.dart';
...
void main() {
  group("Testing the 'DurandKerner' class for polynomial roots finding", () {
    test("Making sure that a 'DurandKerner' object is properly constructed",
        () {
