...
void main() {
  group('Linear', () {
    test('Object construction', () {
      ...
      expect(
        equation.derivative(),
        equals(Constant(a: const Complex.fromReal(3))),
      );
      ...
      // Evaluation
      expect(equation.realEvaluateOn(1), equals(const Complex.fromReal(4.2)));
      expect(
    ...
    test('Objects comparison works properly', () {
      ...
      expect(
        Linear(a: const Complex(2, 3), b: const Complex.i()) == fx,
        isTrue,
      );
      expect(
        fx.hashCode,
        equals(Linear(a: const Complex(2, 3), b: const Complex.i()).hashCode),
      );
    });
