...
void main() {
  group("Testing the 'Bisection' class", () {
    test("Making sure that the series converges when the root is in the interval.", () async {
      ...
      expect(bisection.function, equals("f(x) = x^3-x-2"));
    ...
    test("Making sure that the bisection method still works when the root is "
