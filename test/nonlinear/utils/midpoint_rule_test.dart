...
void main() {
  ...
  group("Testing the behaviors of the MidpointRule class.", () {
    ...
    test(
      ...
      // 'integrateOn' method.
      final bisection = Bisection(function: "sin(2*x)-1/2", a: -1.7, b: -0.5);

      // Evaluation
      final integral = bisection.integrateOn(const MidpointRule(
        lowerBound: 0.5,
        upperBound: 1,
        intervals: 40,
      ));

      expect(integral.result, MoreOrLessEquals(0.22, precision: 1.0e-2));
    });
  });
}
